...
<div class="logecho">
    ...
    ?>
    <li class="decmt-box">
		<p><center><a href="#addcomment">请输入密码再查看评论内容.</a></center></p>
    </li>
    <?php 
        } else if ( !comments_open() ) {
    ?>
    <li class="decmt-box">
		<p><center><a href="#addcomment">评论功能已经关闭!</a></center></p>
    </li>
    <?php 
        } else if ( !have_comments() ) { 
    ?>
    <li class="decmt-box">
		<p><center><a href="#addcomment">还没有任何评论，你来说两句吧</a></center></p>
    </li>
    <?php 
        } else {
...
<form id="commentform" name="commentform" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">
    <div class="logtitle">发表评论:</div>
	<a name="addcomment"></a>
    <ul id="plk">
        <?php if ( !is_user_logged_in() ) : ?>
        <li class="clearfix">
            <label for="name">昵称(必须)</label>
